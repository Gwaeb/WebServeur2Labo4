...
paul = User.create!(nom: "Paul", prenom: "Tremblay", email: "paul@tremblay.com", password: "123456", is_admin: 0)
george = User.create!(nom: "George", prenom: "Germain", email: "george@germain.com", password: "123456", is_admin: 0)
jacque = User.create!(nom: "Jacque", prenom: "Germain", email: "jacque@germain.com", password: "123456", is_admin: 0)
daniel = User.create!(nom: "Daniel", prenom: "Peterson", email: "daniel@peterson.com", password: "123456", is_admin: 0)
robert = User.create!(nom: "Robert", prenom: "Skywalker", email: "robert@skywalker.com", password: "123456", is_admin: 0)
admin = User.create!(nom: "Admin", prenom: "Admin", email: "admin@admin.com", password: "123456", is_admin: 1)
